...
class LearningNode(Node):
    def __init__(self):
        ...
        self.staps_per_episode_path = LOG_FILE_DIR+'/steps_per_episode.csv'

        self.logs_reward_per_episode_path = LOG_FILE_DIR+'/logs_reward_per_episode.csv'
        self.reward_per_episode_path = LOG_FILE_DIR+'/reward_per_episode.csv'

        self.q_table_path = LOG_FILE_DIR+'/Qtable.csv'
        self.state_space_path = LOG_FILE_DIR+'/StateSpace.csv'
        self.T_per_episode_path = LOG_FILE_DIR+'/T_per_episode.csv'
        self.t_per_episode_path = LOG_FILE_DIR+'/t_per_episode.csv'
        self.EPSILON_per_episode_path = LOG_FILE_DIR+'/EPSILON_per_episode.csv'
        self.reward_min_per_episode_path = LOG_FILE_DIR+'/reward_min_per_episode.csv'
        self.reward_max_per_episode_path = LOG_FILE_DIR+'/reward_max_per_episode.csv'
        self.reward_avg_per_episode_path = LOG_FILE_DIR+'/reward_avg_per_episode.csv'

        if os.path.isfile(self.logs_steps_per_episod_path):
            self.logs_steps_per_episode = np.genfromtxt(self.logs_steps_per_episod_path,delimiter = ' , ')
        else:
            self.logs_steps_per_episode = np.array([])

        self.steps_per_episode = np.array([])

        if os.path.isfile(self.logs_reward_per_episode_path):
            self.logs_reward_per_episode = np.genfromtxt(self.logs_reward_per_episode_path,delimiter = ' , ')
        else:
            self.logs_reward_per_episode = np.array([])
    ...
    def save_info_csv(self):
        ...
        saveQTable(self.q_table_path, self.Q_table)
        np.savetxt(self.state_space_path, self.state_space, '%d')

        np.savetxt(self.staps_per_episode_path, self.steps_per_episode, delimiter = ' , ')
        np.savetxt(self.logs_steps_per_episod_path , self.logs_steps_per_episode, delimiter = ' , ')

        np.savetxt(self.reward_per_episode_path, self.reward_per_episode, delimiter = ' , ')
        np.savetxt(self.logs_reward_per_episode_path, self.logs_reward_per_episode, delimiter = ' , ')

        np.savetxt(self.T_per_episode_path, self.T_per_episode, delimiter = ' , ')
        np.savetxt(self.EPSILON_per_episode_path, self.EPSILON_per_episode, delimiter = ' , ')
        np.savetxt(self.reward_min_per_episode_path, self.reward_min_per_episode, delimiter = ' , ')
        np.savetxt(self.reward_max_per_episode_path, self.reward_max_per_episode, delimiter = ' , ')
        np.savetxt(self.reward_avg_per_episode_path, self.reward_avg_per_episode, delimiter = ' , ')
        np.savetxt(self.t_per_episode_path, self.t_per_episode, delimiter = ' , ')
